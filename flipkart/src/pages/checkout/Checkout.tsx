...
const Checkout = () => {
  ...
  const handlePay = (e) => {
   if (!ref2.current && !ref3.current)return setError(
    {...error,address:"Address required",method:"Payment method required"}) 
   if(!ref2.current)return setError({...error,address:"Address required"});
   if(!ref3.current)return setError({...error,method:"Payment method required"});
          ...
          <div className="checkout__user__information">
            <div className="checkout__user__information_content">
              ...
              <div className="info__common checkout__user__address ">
                ...
                <span className="checkout__add__pay_error">{error.address}</span>
                {editAddress ? (
                  <input
                    ref={ref1}
                    type="text"
