...
const Card = ({product}) => {
  ...
  return (
    <div className="card__container" data-id = {product.category_id} onClick={(e)=>handleData(e)}>
      <div data-id = {product.category_id} className="card__content">
        <div className="card__img"><img data-id = {product.category_id} src={product.image_url} alt="" /></div>
